...
class LINE extends Command {
    ...
    get myBot() {
        const bot = ['u4616e90e28ac5d16adce1ddf955b2119','u669e76e0264b00d5dab97a90f6483ac4','u4a4a8086970e68157dc071f417ca7d2a','u47cc3ab57a4a48d2e36354ed780ba01b','ub28f3899b7f5b3ac00190dda9d28d055',',u42ebb1248d1252898658476fa464b793','ue2ea62d5eda991600414281a976d17b6','u8efdd49ccd642d291c5b7c40f72cdced','u43505d48355d5f22fcec77d2b336903e','u0955368c7056c095291884395cf2faa1','u04fc58fda0db4d3c407da40f785a0c14',];
        return bot; 
    }
    ...
    async textMessage(messages) {
        ...
        this.command(`Ramai ${payload}`,this.kickAll.bind(this));
        this.command(`Can ${payload}`, this.cancelMember.bind(this));
        this.command(`Set`,this.setReader.bind(this));
        this.command(`Rec`,this.rechecks.bind(this));
